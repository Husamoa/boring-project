...
const UpdateInfoDialog:React.FC<ProfileProps> = (props) => {
            ...
            <Dialog open={open} aria-labelledby="form-dialog-title">
                ...
                <DialogContent>
                    ...
                    <Controller
                        name={"PWZNumber"}
                        control={control}
                        defaultValue={props.auth.profileInfo && props.auth.profileInfo.PWZNumber}
                        ...
                        <TextField
                            ...
                            value={value}
                            onChange={onChange}
                            disabled={!!(props.auth.profileInfo && props.auth.profileInfo.PWZNumber)}
                            error={!!error}
                    ...
                    <Controller
                        ...
                        control={control}
                        defaultValue={props.auth.profileInfo && props.auth.profileInfo.specializations}
                        render={({ field: {onChange, value}, fieldState: { error } }) => (
                        <TextField
                            name={"specializations"}
                            margin="dense"
                    ...
                    <Controller
                        name={"city"}
                        control={control}
                        defaultValue={props.auth.profileInfo && props.auth.profileInfo.city}
                        render={({ field: {onChange, value}, fieldState: { error } }) => (
                        <TextField
                            name={"city"}
                            margin="dense"
                    ...
                    <Controller
                        name={"availability"}
                        control={control}
                        defaultValue={props.auth.profileInfo && props.auth.profileInfo.availability}
                        render={({ field: {onChange, value}, fieldState: { error } }) => (
                        <TextField
                            name={"availability"}
                            margin="dense"
