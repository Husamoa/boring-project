...
const Header:React.FC<ProfileProps> = (props) => {
    ...
    const handleProfileMenuOpen = (event: React.MouseEvent<SetStateAction<any>>) => {
    ...
    const handleMobileMenuOpen = (event: React.MouseEvent<React.SetStateAction<null>>) => {
    ...
    const toggleDrawer = (open:boolean) => (event:React.MouseEvent<HTMLDivElement> | React.KeyboardEvent):void => {
